...
class App(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("                 grid_layout VERSION:2        ")
        ...
        self.grid_layout.addWidget(self.button4, 1, 0, 1, 2)
        self.grid_layout.addWidget(self.button5, 1, 2)
        self.grid_layout.addWidget(self.button6, 2, 0)
        self.grid_layout.addWidget(self.button7, 2, 1, 1, 2)
